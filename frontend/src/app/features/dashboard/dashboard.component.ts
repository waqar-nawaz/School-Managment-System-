    ...
    @if (loading) {
      ...
      <div class="card">
        ...
        <div class="page-actions" style="justify-content:flex-start;flex-wrap:wrap">
          <a class="btn btn-outline" routerLink="/admissions">New admission</a>
          <a class="btn btn-outline" routerLink="/attendance">Take attendance</a>
          <a class="btn btn-outline" routerLink="/invoices">Create invoice</a>
          <a class="btn btn-outline" routerLink="/reports">Generate report</a>
        </div>
      </div>
    }
  `,
