...
export const RESOURCE_CONFIGS: Record<string, ResourceConfig> = {
  ...
  parents: {
    key: 'parents', label: 'Parents / Guardians', api: '/parents',
    columns: [nameCol('fullName', 'Name'), nameCol('relation', 'Relation'), nameCol('phone'), nameCol('email'), nameCol('occupation'), boolCol('isActive', 'Active')],
    fields: fields([
  ...
  students: {
    ...
    columns: [
      nameCol('admissionNo', 'Admission No'),
      nameCol('firstName', 'First'),
      nameCol('lastName', 'Last'),
      nameCol('guardianPhone', 'Guardian Phone'),
      nameCol('email', 'Email'),
      { key: 'currentClassId', label: 'Class', type: 'number' },
      { key: 'admissionStatus', label: 'Status', type: 'badge', badgeMap: BADGE_COMMON },
      boolCol('isActive', 'Active'),
    ],
    fields: fields([
      { key: 'admissionNo', label: 'Admission number', required: true, hint: 'Unique student admission number.' },
      { key: 'firstName', label: 'First name', required: true },
      { key: 'lastName', label: 'Last name' },
      { key: 'gender', label: 'Gender', type: 'select', options: GENDER },
      { key: 'dateOfBirth', label: 'Date of birth', type: 'dateonly' },
      ...
      { key: 'address', label: 'Address', type: 'textarea' },
      { key: 'admissionDate', label: 'Admission date', type: 'dateonly' },
